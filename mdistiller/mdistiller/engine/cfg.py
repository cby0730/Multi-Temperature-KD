...
# MTKD
CFG.MTKD = CN()
CFG.MTKD.INIT_TEMPERATURE = [4.0, 3.0, 2.0, 1.0]
CFG.MTKD.TEMPERATURE = 4
CFG.MTKD.LABELSMOOTH = [0.1, 0.2]
CFG.MTKD.WARMUP = 20
CFG.MTKD.BASE = "DKD"
CFG.MTKD.LOSS = CN()
CFG.MTKD.LOSS.CE_WEIGHT = 1.0
CFG.MTKD.LOSS.KD_WEIGHT = 1.0
CFG.MTKD.LOSS.DTKD_WEIGHT = 1.0
CFG.MTKD.LOSS.TCKD_WEIGHT = 1.0
CFG.MTKD.LOSS.NCKD_WEIGHT = 3.0
